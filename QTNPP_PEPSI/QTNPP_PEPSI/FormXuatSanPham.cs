...
namespace QTNPP_PEPSI
{
    public partial class FormXuatSanPham : Form
    {
        ...
        #region Ghi chú, tổng tiền, trạng thái của Hóa đơn xuất
        ...
        private void GvPhieuXuat_Click(object sender, EventArgs e)
        {
        ...
        private void GvChiTietPhieuXuat_Click(object sender, EventArgs e)
        {
            cbbMaLoaiSP.Text = "";
        ...
        private void btnTaoMoi_Click(object sender, EventArgs e)
        {
            ...
            DTPNgayXuat.Text = ngay.ToString("dd/MM/yyyy");
