...
namespace QTNPP_PEPSI
{
    public partial class FormBanSanPham : Form
    {
        ...
        private void FormBanSanPham_Load(object sender, EventArgs e)
        {
            ...
            cbbTenKhachHang.DataSource = kh.load_TenKH0();
        ...
        #region Tính VAT, Tổng tiền của Hóa đơn
        ...
        private void GvHoaDon_Click(object sender, EventArgs e)
        {
        ...
        private void GvChiTietHD_Click(object sender, EventArgs e)
        {
            cbbMaLoaiSP.Text = "";
        ...
        {
            cbbMaSP.DataSource = sp.load_TenSP0(cbbMaLoaiSP.SelectedValue.ToString());
        ...
        private void btnTaoMoi_Click(object sender, EventArgs e)
        {
            ...
            DTPNgayLap.Text = ngay.ToString("dd/MM/yyyy");
        ...
        private void btnLapHoaDon_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                HOADONBAN hd = new HOADONBAN
                {
                    ...
                    TONGTIENBAN = Convert.ToDecimal(TinhTongTien())
                };
