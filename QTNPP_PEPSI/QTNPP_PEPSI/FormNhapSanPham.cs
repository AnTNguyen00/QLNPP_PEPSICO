...
namespace QTNPP_PEPSI
{
    public partial class FormNhapSanPham : Form
    {
        ...
        private void FormNhapSanPham_Load(object sender, EventArgs e)
        {
            ...
            DTPNgayNhap.Text = GvPhieuNhap.CurrentRow.Cells[1].Value.ToString();

            //không cho nhập dữ liệu vào combobox
            this.cbbTenNhaCC.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
        ...
        #region Ghi chú, trạng thái, tổng tiền của hóa đơn nhập
        ...
        private void GvPhieuNhap_Click(object sender, EventArgs e)
        {
        ...
        #region Số lượng, số lượng tồn theo Sản phẩm
        ...
        private void GvChiTietPhieuNhap_Click(object sender, EventArgs e)
        {
            cbbMaLoaiSP.Text = "";
        ...
        private void btnTaoMoi_Click(object sender, EventArgs e)
        {
            ...
            DTPNgayNhap.Text = ngay.ToString("dd/MM/yyyy");
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            try
            {
                if (hdn.sua_CTHDN(txtMaPN.Text, cbbMaSP.Text, int.Parse(txtSoLuong.Text), decimal.Parse(txtGiaNhap.Text), decimal.Parse(txtThanhTien.Text)) == 1)
                {
